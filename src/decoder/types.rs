    ...
    pub fn encode(self) -> Vec<Value> {
        let mut values = vec![
            ...
            Value::String(match self.pattern {
                ...
                Pattern::NervapeSeries => "nervapeSeries".to_owned(),
    ...
    let traits_base = traits_pool
        ...
        .map(|schema| {
            ...
            let pattern = match pattern_str {
                ...
                "nervapeSerialNumber" => Pattern::NervapeSerialNumber,
                "nervapeColor" => Pattern::NervapeColor,
                "nervapeNote" => Pattern::NervapeNote,
                "nervapeSeries" => Pattern::NervapeSeries,
                "nervapeString" => Pattern::NervapeString,
                "nervapeInvolved" => Pattern::NervapeInvolved,
                "nervapeDescription" => Pattern::NervapeDescription,
                "nervapeJob" => Pattern::NervapeJob,
